...
void EmotionalController::render(){
    ...
    {
        SimpleGUI::CheckBox(using_param, U"use param control", display_checkbox_text.pos, display_checkbox_text.w, active);
        display_axis_guide_font(U"X").draw(int(display_x_axis_label.h * 0.7), Arg::center = display_x_axis_label.center());
        ...
        display_axis_guide_font(U"Y").draw(int(display_y_axis_label.h * 0.7), Arg::center = display_y_axis_label.center());
